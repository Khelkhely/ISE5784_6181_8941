...
class TubeTest {
    ...
    void testFindIntersections() {
        ...
        assertNull(list,
                "ERROR: returns intersection points instead of null");
        ...
        assertNull(list,
                "ERROR: returns intersection point instead of null");
        ...
        // TC26: the ray is on the same line as the axis in the opposite direction,
        // and starts before the head of the axis
        list = tube.findIntersections(new Ray(new Point(0,4,2), new Vector(0,-4,-1)));
        assertNull(list,
                "ERROR: returns intersection point instead of null");

        // TC27: the ray is on the same line as the axis in the opposite direction,
        // and starts after the head of the axis
        list = tube.findIntersections(new Ray(new Point(0,-4,0), new Vector(0,-4,-1)));
        assertNull(list,
                "ERROR: returns intersection point instead of null");
        ...
        // TC29: the ray is tangent and orthogonal to the tube
        ...
        // the ray starts at the head of the axis:
        ...
        // TC35: the ray starts at the head of the axis and is orthogonal to it
    ...
    /**
     * Test method for {@link Tube#${name}(${parameters})}
     */
    @Test
    void testFindGeoIntersections() {
        Tube tube = new Tube(1d, new Ray(new Point(2,0,-1), Vector.Z));
        Ray ray = new Ray(new Point(-1,0,0), new Vector(1,0,0));

        // ============ Equivalence Partitions Tests ==============
        // TC01: intersection points are further away than the max distance
        assertNull(tube.findGeoIntersections(ray,1),
        ...
        assertEquals(1,
                tube.findGeoIntersections(ray,3).size(),
        ...
        assertEquals(2,
                tube.findGeoIntersections(ray,5).size(),
        ...
        assertEquals(1,
                tube.findGeoIntersections(ray,2).size(),
        ...
        assertEquals(2,
                tube.findGeoIntersections(ray,4).size(),
