...
class GeometriesTest {
    ...
    void testFindIntersections() {
        ...
        Sphere s = new Sphere(1, new Point(2,0,0));
        Plane p = new Plane(new Point(-3,0,0), new Point(0,0,3), new Point(0,-3,0));
        Triangle t = new Triangle(new Point(1,2,3), new Point(0,4,0), new Point(4,0,0));
        Geometries geometries = new Geometries(s,p,t);
