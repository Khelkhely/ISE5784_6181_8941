...
class VectorTest {
    ...
    void testLengthSquared() {
        ...
        assertEquals(9, v4.lengthSquared(), 0.00001,
    ...
    void testLength() {
        ...
        assertEquals(3, v4.length(), 0.00001,
    ...
    void testNormalize() {
        ...
        assertEquals(1, u.length(), 0.00001,
    ...
    void testCrossProduct() {
        ...
        assertEquals(v1.length() * v3.length(), v.length(), 0.00001,
                "crossProduct() wrong result length");
        // TC02: Test cross-product result orthogonality to its operands
        assertEquals(0, v.dotProduct(v1),
                "crossProduct() result is not orthogonal to 1st operand");
        assertEquals(0, v.dotProduct(v3),
